        ...
        <el-dialog
            ...
            <div class="info-content">
                ...
                <div class="info-container">
                    <div class="info-item">公示用煤名称：<b>云南能投曲靖发电有限公司</b></div>
                    <div class="info-item">企业名称：<b>云南能投曲靖发电有限公司</b></div>
                    <div class="info-item">关联企业名称：<b>云南能投曲靖发电有限公司</b></div>
                    <div class="flex" style="margin: 30px 0">
                        <div style="width: 400px">所属省：云南省</div>
                        <div>所属市：曲靖市</div>
                    </div>
                    <div class="flex" style="margin: 30px 0">
                        <div style="width: 400px">联系人：</div>
                        <div>联系电话：</div>
                    </div>
                ...
                <div class="info-container">
                    <div class="flex" style="margin: 30px 0">
                        <div style="width: 400px">确认量：492.00&emsp;万吨</div>
                        <div>平台核验通过量：492.00&emsp;万吨</div>
                    </div>
                    <div class="flex" style="margin: 30px 0">
